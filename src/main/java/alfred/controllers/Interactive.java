...
public class Interactive {
    ...
    ResponseEntity<String> interactivePOST(HttpEntity<String> request,
                                           ...
                                           @RequestBody String body) throws InvalidKeyException, NoSuchAlgorithmException {
    ...
    private ResponseEntity<String> respondToUserChoice(InteractiveResponse interactiveResponse) {
        ...
        SlackResponse slackResponse = new GeneralFunctions().postSlackMessage(interactiveResponse.getResponse_url(), envVars.getSlackToken(), repo.toJson());
